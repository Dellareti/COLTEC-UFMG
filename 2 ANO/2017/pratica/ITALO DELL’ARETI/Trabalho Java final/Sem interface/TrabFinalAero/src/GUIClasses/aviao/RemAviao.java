 ...
 * @author raulf
 */
public class RemAviao extends javax.swing.JFrame {
    AllData dados;
    DefaultListModel model = new DefaultListModel();
    
    public RemAviao(AllData dados) {
        initComponents();
        this.dados=dados;
    ...
    private void initComponents() {
        ...
        listaAviao = new javax.swing.JList<>();
        btRemover = new javax.swing.JButton();
        lbTitulo = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);

        scrollPanePainel.setViewportView(listaAviao);
        ...
        lbTitulo.setText("REMOVER AVIAO");
    ...
    private void btRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btRemoverActionPerformed
        if(listaAviao.getSelectedIndex()!=-1){
            int dialogButton = JOptionPane.YES_NO_OPTION;
            int dialogResult = JOptionPane.showConfirmDialog(this, "Deseja mesmo remover o aviao: "+ dados.getAvioes().get(listaAviao.getSelectedIndex()).getNumModelo()+" ?", "Confirme", dialogButton);
            if(dialogResult == 0) {
                JOptionPane.showMessageDialog(null,"Este Aviao foi removido!","Inf.",1);        
                dados.removeAviao(listaAviao.getSelectedIndex());
                model.removeElementAt(listaAviao.getSelectedIndex());
                dados.escreverDadosAvioes();
            }
            else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemAviao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new RemAviao(null).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JList<String> listaAviao;
