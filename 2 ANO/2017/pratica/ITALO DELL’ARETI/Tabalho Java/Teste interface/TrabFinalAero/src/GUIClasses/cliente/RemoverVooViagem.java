...
public class RemoverVooViagem extends javax.swing.JFrame {
    AllData dados;
    DefaultListModel model = new DefaultListModel();
    static int pos=-1;

    public RemoverVooViagem(AllData dados) {
        initComponents();
        this.dados=dados;
    ...
    private void initComponents() {
        ...
        lbTitulo.setText("Remover voo de reserva");

        jLabel1.setText("Voos");

        jButton1.setText("Remover voo");
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        ...
        if(listaReservas.getSelectedIndex()!=-1){
            ...
            if(find!=null){
                for(ReservaDeVoo dsa:find.getReservasDeVoos()){
                    caixa.addItem(dsa.getVoo().getDescVoo().getNumeroDoVoo());
                }
                caixa.removeAllItems();
