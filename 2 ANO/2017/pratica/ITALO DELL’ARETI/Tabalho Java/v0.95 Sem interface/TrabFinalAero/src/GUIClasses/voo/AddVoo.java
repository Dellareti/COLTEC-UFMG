...
public class AddVoo extends javax.swing.JFrame {
    ...
    private void CriarVooBtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CriarVooBtActionPerformed
        ...
        int mes = Integer.parseInt(data.substring(2,3));
        int ano = Integer.parseInt(data.substring(4,7));
 
        int hr = Integer.parseInt(horarioPartTxt.getText().substring(0,1));
        int min  = Integer.parseInt(horarioPartTxt.getText().substring(2,3));
        
        int hr2 = Integer.parseInt(horarioDestTxt.getText().substring(0,1));
        int min2  = Integer.parseInt(horarioDestTxt.getText().substring(2,3));
        boolean clarisse = false;
        ...
        if(hr < 0 || hr > 24 || min < 0 || min > 60){
                JOptionPane.showMessageDialog(null,"Horário Inválido","Erro",0);
                clarisse = true;
        }

        if(hr2 < 0 || hr2 > 24 || min2 < 0 || min2 > 60){
                JOptionPane.showMessageDialog(null,"Horário Inválido","Erro",0);
                clarisse = true;
        }
        ...
        if(!clarisse){
            ...
            Voo voo = new Voo(dataTxt.getText(),Integer.parseInt(this.dados.buscaAviaoModel((String) opcoesAviao.getSelectedItem()).getNumAssentos()),new DescricaoVoo(horarioPartTxt.getText(),horarioDestTxt.getText()));
