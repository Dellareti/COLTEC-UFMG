...
int somaNos(no *p){
    int soma;//troquei de lugar 20/05
     if(p != NULL){
 ...
 int menu(){
           ...
           printf("12 - valor da soma de nos");
           printf("13 - Sair\n\n>>>>>>>>>>MENU<<<<<<<<<<\n\n\n");
...
int main(){
    ...
    while(opcao!=13){//12? Assim ele não consegue fazer a soma! troquei para 13
    system("cls");
    opcao = menu();
    switch(opcao){
